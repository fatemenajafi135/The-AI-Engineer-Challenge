...
export const styles: Record<string, CSSProperties> = {
  ...
  breathingDoneToast: {
    width: "100%",
    padding: "14px 16px",
    background: COLORS.accentOverlay08,
    borderRadius: "12px",
    border: `1px solid ${COLORS.accentOverlay18}`,
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    gap: "10px",
  ...
  reframeDistortionPill: {
    ...
    borderRadius: "20px",
    border: `1px solid ${COLORS.accent}`,
    background: COLORS.accentOverlay10,
    color: COLORS.accent,
    fontSize: "11px",
    fontWeight: 700,
    textTransform: "uppercase" as const,
  ...
  prepTabActive: {
    ...
    borderRadius: "20px",
    border: `1px solid ${COLORS.accent}`,
    background: COLORS.accentOverlay15,
    color: COLORS.accent,
    fontSize: "12px",
    fontWeight: 700,
    cursor: "pointer",
  ...
  supportCrisisStrip: {
    ...
    gap: "8px",
    padding: "10px 20px",
    background: COLORS.accentOverlay06,
    borderBottom: `1px solid ${COLORS.accentDim}`,
  },
  supportCrisisLabel: {
    fontSize: "11px",
